      ...
      <section className=" bg-[#002233]">
        ...
        <section class="text-gray-600 body-font">
          <div id="about" class="container px-5 py-24 mx-auto ">
            <h1 className=" sm:text-6xl text-3xl mb-4 font-medium text-[#F6BE00] flex justify-center items-center p-8">
              About me
            </h1>
            <div class="flex ">
              <div class="p-4 ">
                <div class="h-full bg-[#f1f5f8] p-8 rounded">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                  ...
                  <p class="leading-relaxed mb-6 text-gray-700 bg-[#f1f5f8]">
